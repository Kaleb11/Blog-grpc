...
type AuthServiceClient interface {
	...
	SignInUser(ctx context.Context, in *SignInUserInput, opts ...grpc.CallOption) (*GenericSignInResponse, error)
	VerifyEmail(ctx context.Context, in *VerifyEmailRequest, opts ...grpc.CallOption) (*GenericResponse, error)
	ForgotPassword(ctx context.Context, in *ForgotPasswordInput, opts ...grpc.CallOption) (*GenericResponse, error)
	ResetPassword(ctx context.Context, in *ResetPasswordInput, opts ...grpc.CallOption) (*GenericResponse, error)
}
...
func (c *authServiceClient) SignInUser(ctx context.Context, in *SignInUserInput, opts ...grpc.CallOption) (*GenericSignInResponse, error) {
	out := new(GenericSignInResponse)
...
func (c *authServiceClient) ForgotPassword(ctx context.Context, in *ForgotPasswordInput, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
...
func (c *authServiceClient) ResetPassword(ctx context.Context, in *ResetPasswordInput, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
...
type AuthServiceServer interface {
	...
	SignInUser(context.Context, *SignInUserInput) (*GenericSignInResponse, error)
	VerifyEmail(context.Context, *VerifyEmailRequest) (*GenericResponse, error)
	ForgotPassword(context.Context, *ForgotPasswordInput) (*GenericResponse, error)
	ResetPassword(context.Context, *ResetPasswordInput) (*GenericResponse, error)
...
func (UnimplementedAuthServiceServer) SignInUser(context.Context, *SignInUserInput) (*GenericSignInResponse, error) {
...
func (UnimplementedAuthServiceServer) ForgotPassword(context.Context, *ForgotPasswordInput) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ForgotPassword not implemented")
}
func (UnimplementedAuthServiceServer) ResetPassword(context.Context, *ResetPasswordInput) (*GenericResponse, error) {
...
func _AuthService_ForgotPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ForgotPassword(ctx, req.(*ForgotPasswordInput))
	}
	return interceptor(ctx, in, info, handler)
}
